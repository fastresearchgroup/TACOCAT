...
plt.ylabel('Density - kg/m^3',fontsize = fs)
...
plt.xlabel('Temperature - C',fontsize = fs)
plt.ylabel('Specific Heat Capacity - J/kg-K',fontsize = fs)
plt.legend(loc='upper right',fontsize = fs)
plt.rc('xtick', labelsize=14) 
plt.rc('ytick', labelsize=14)
plt.grid()
...
plt.xlabel('Temperature - C',fontsize = fs)
plt.ylabel('Viscosity - m^2/s',fontsize = fs)
plt.legend(loc='upper right',fontsize = fs)
plt.rc('xtick', labelsize=14) 
plt.rc('ytick', labelsize=14)
plt.grid()
...
plt.xlabel('Temperature - C',fontsize = fs)
plt.ylabel('Thermal Conductivity - W/m-K',fontsize = fs)
plt.legend(loc='upper right',fontsize = fs)
plt.rc('xtick', labelsize=14) 
plt.rc('ytick', labelsize=14)
plt.grid()
